...
* [Unable to install due to controlled folder access](http://help.syncfusion.com/jsp/installation/installation-errors#unable-to-install-due-to-controlled-folder-access)
