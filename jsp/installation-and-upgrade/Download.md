...
# Download JSP Installer

The Syncfusion JSP installer can be downloaded from the [Syncfusion](https://www.syncfusion.com/jquery/jsp-ui-controls) website.
...
2. After completing the required form or logging in with your registered Syncfusion account, you can download the JSP installer from the confirmation page. (as shown in below screenshot.) 
...
7. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio JSP Offline installer which is available in EXE and ZIP format.
...
You can also refer to the [**Online installer**](https://help.syncfusion.com/jsp/installation-and-upgrade/install-using-the-web-installer) and [**Offline installer**](https://help.syncfusion.com/jsp/installation-and-upgrade/install-using-the-offline-installer) links for step-by-step installation guidelines.