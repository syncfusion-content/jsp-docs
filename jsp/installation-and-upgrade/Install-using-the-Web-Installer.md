---
layout: post
title: Installation process for Syncfusion Essential Studio JSP products
description: This section provides information regarding the Syncfusion JSP Online installer and steps for installing it
platform: JSP
...
The following procedure illustrates how to install Essential Studio JSP Online Installer setup. 

1.  Double-click the Syncfusion Essential Studio JSP Online Installer setup file. The Setup Wizard opens and extracts the package automatically.
...
2. Welcome wizard of the Syncfusion JSP Online Installer will be displayed. Click Next.
...
The following procedure illustrates how to uninstall Essential Studio JSP from Web Installer setup. 
...
The following procedure illustrates how to install/uninstall Essential Studio JSP from Web Installer setup. 
